---
title: "Functionnal_trait_based_analysis"
...
-   A partir des matrices d'abondances de chacunes des conditions, il est possible de regarder la composition spécifique pour chacune de ces condtions et de les comparer entre elles suivant un script précédemment fait.

-   Explorer la possibilité une classification fonctionelle pour la partie biotique de l'habitat 3D par exemple avec des classes de volumes d'habitat, des types de substrats etc. Permettrait d'obtenir de nouvelles indications sur la complexité fonctionelle de l'habitat.

-   

## Notes :

Plus besoin du Fichier Weight.csv (il est directement calculé en fonction de l'abondance de chacune des spp).

## Functionnal trait analysis

This analysis is based on the work of Gomez Gras *et al.*, 2021, working on the change of the functional identity of coralligenous reef facing marine heat waves. The approach used, is also also based on the work of Teixido *et al.* 2018 on the characterization of changes in ecosystem function accross CO2 gradients.

## Organisms clasification into functionnal entities

This classification allows to create a unique code for organizations sharing the same functional characteristics. This code, called FE -Fuctional Entities-, represent a group of species pocessing an identical combination of categorised/ranked trait values. It is a combination of the values associated with the following 12 different functional traits :
...
Trait values were selected as the most accurate average description of species-specific traits. As some species show plasticity in the expression of certain traits and we were interested in global comparisons across species rather than on intraspecific variation, a fuzzy coding procedure based on coarse ranked and nominal categories was applied (Cheven *et al.,* 1994).
