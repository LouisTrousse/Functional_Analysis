...
Once all files and working directory specify, the installation and loading of packages usefull for the analysis is required.

## Conducte the Functionnal Analysis
